...
conjunción xs = conjuncionAc xs True 
   where
      conjuncionAc [] ac = ac
      conjuncionAc (x:xs) ac = conjuncionAc xs (x==ac)
...
borraTodas _ [] = []{-La barra baja quiere decir para cualquier valor de x se cumple el caso base-}
